...
document.write('<script src="../static/msgin/' + Code.LANG + '.js"></script>\n');
// Load Blockly's language strings.
//'<script src=" {{ url_for(\'static\', filename="msgout/js/' + Code.LANG + '.js")}}"></script>
document.write('<script src="../static/msgout/js/' + Code.LANG + '.js"></script>\n');
